  ...
  return (
    ...
    >
      <div className="space-y-3 text-left">
        ...
        <FormField label="编排计划（每行一步）" hint="多技能编排步骤；留空则用主技能计划">
          <FormTextarea
            rows={4}
            className="font-mono text-[12px]"
            placeholder={'挂载主技能\n执行辅助技能\n汇总行动建议'}
        ...
        <FormField label="挂载技能" hint="勾选后可编排；主技能决定默认 /指令">
          <div className="mt-1 max-h-40 overflow-y-auto rounded-xl border border-black/8 p-2">
            {skills.length ? (
              ...
              <p className="p-2 text-[12px] text-[#86868b]">请先在技能中心添加技能</p>
            )}
          </div>
        </FormField>
